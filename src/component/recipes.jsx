...
export default function Recipes() {
  return (
    <>
      <section className="flex flex-col justify-center items-center p-6 gap-6 drop-shadow-xl mb-12 w-full">
        <div className="flex flex-col justify-center items-center gap-6 bg-gray-200 rounded-[50px] p-4 w-full lg:w-auto drop-shadow-xl ">
          <hi className=" text-2xl font-bold text-center">Recipes</hi>
          <div
            className="flex flex-col justify-center items-center gap-2 lg:gap-10 bg-gray-300
          ...
          >
            ...
            <li className="w-5/6">4 salmon fillets</li>
            <li className="w-5/6">2 cups cooked brown rice</li>
            <li className="w-5/6">1bunch of asparagus</li>
            <li className="w-5/6">Olive oil, salt, and pepper for seasoning</li>
            <div>
            ...
            <div>
              ...
              <li>Protein: Approximately 30g</li>
              <li>Carbs: Approximately 40g</li>
              <li>Kcal: Approximately 400 kcal</li>
            </div>
          </div>
          <div
            className="flex flex-col justify-center items-center gap-2 lg:gap-10 bg-gray-300
          ...
          >
            ...
            />
            <span className="text-xl"> Ingredients</span>
            <li className="w-5/6">1 lb lean beef strips</li>
            <li className="w-5/6">
              Assorted mixed vegetables (e.g., bell peppers, broccoli, carrots)
            </li>
            <li className="w-5/6">Stir-fry sauce (low-sodium)</li>
            <li className="w-5/6">Brown rice or quinoa</li>
            <div>
              <span className="text-xl">Instructions</span>
              <li>
              ...
              <li>Serve the beef and vegetables over brown rice or quinoa</li>
            </div>
            <div>
              <span className="text-xl">
                Nutritional Information (per serving)
              </span>
              <li>Protein: Approximately 35g</li>
              <li>Carbs: Approximately 25g</li>
              <li>Kcal: Approximately 400 kcal</li>
            </div>
          </div>
          <div
